...
export default function Profile() {
  ...
  const { image } = useContext(ComentsContext);
  ...
  return (
    <>
      ...
      <div className="text-white fixed left-56  mx-20 text-xl top-16 z-20">
        {profile["accountName"]}
      </div>
      ...
      <div
        className="z-20 w-9/12 h-40 fixed left-44 bottom-10"
        style={{
